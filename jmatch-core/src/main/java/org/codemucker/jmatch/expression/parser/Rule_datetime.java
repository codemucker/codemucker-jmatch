...
final public class Rule_datetime extends Rule
{
  public Rule_datetime(String spelling, ArrayList<Rule> rules)
  {
  ...
  public static Rule_datetime parse(ParserContext context)
  {
    ...
    parsed = false;
    {
      ...
      if (parsed)
      {
        ...
        {
          Rule rule = Rule_date.parse(context);
          if ((f1 = rule != null))
          {
              ...
              for (int i2 = 0; i2 < 1 && f2; i2++)
              {
                ...
                parsed = false;
                {
                  ...
                  if (parsed)
                  {
                    ...
                    {
                      Rule rule = Terminal_StringValue.parse(context, "T");
                      if ((f3 = rule != null))
                      {
        ...
        for (int i1 = 0; i1 < 1 && f1; i1++)
        {
          ...
          parsed = false;
          {
            ...
            if (parsed)
            {
              ...
              for (int i2 = 0; i2 < 1 && f2; i2++)
              {
                Rule rule = Rule_tz.parse(context);
                if ((f2 = rule != null))
                {
                  a2.add(rule, context.index);
                  c2++;
    ...
    if (parsed)
    {
        rule = new Rule_datetime(context.text.substring(a0.start, a0.end), a0.rules);
    }
    else
    {
        context.index = s0;
    ...
    context.pop("datetime", parsed);

    return (Rule_datetime)rule;
  }
}
