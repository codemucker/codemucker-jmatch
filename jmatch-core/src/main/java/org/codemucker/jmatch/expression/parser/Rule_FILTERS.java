...
final public class Rule_FILTERS extends Rule
{
  public Rule_FILTERS(String spelling, ArrayList<Rule> rules)
  {
  ...
  public static Rule_FILTERS parse(ParserContext context)
  {
    ...
    if (parsed)
    {
        rule = new Rule_FILTERS(context.text.substring(a0.start, a0.end), a0.rules);
    }
    else
    {
        context.index = s0;
    ...
    context.pop("FILTERS", parsed);

    return (Rule_FILTERS)rule;
  }
}
