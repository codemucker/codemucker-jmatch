...
final public class Rule_tz extends Rule
{
  public Rule_tz(String spelling, ArrayList<Rule> rules)
  {
  ...
  public static Rule_tz parse(ParserContext context)
  {
    context.push("tz");
              ...
              for (int i2 = 0; i2 < 1 && f2; i2++)
              {
                ...
                parsed = false;
                {
                  ...
                  if (parsed)
                  {
                    ...
                    for (int i3 = 0; i3 < 1 && f3; i3++)
                    {
                      Rule rule = Rule_tzoffset.parse(context);
                      if ((f3 = rule != null))
                      {
                        a3.add(rule, context.index);
                        c3++;
    ...
    if (parsed)
    {
        rule = new Rule_tz(context.text.substring(a0.start, a0.end), a0.rules);
    }
    else
    {
        context.index = s0;
