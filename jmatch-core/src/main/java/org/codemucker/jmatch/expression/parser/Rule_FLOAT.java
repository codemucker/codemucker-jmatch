...
final public class Rule_FLOAT extends Rule
{
  public Rule_FLOAT(String spelling, ArrayList<Rule> rules)
  {
  ...
  public static Rule_FLOAT parse(ParserContext context)
  {
    context.push("FLOAT");
    ...
    if (parsed)
    {
        rule = new Rule_FLOAT(context.text.substring(a0.start, a0.end), a0.rules);
    }
    else
    {
        context.index = s0;
